...
namespace GmailWebClient.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public HttpStatusCodeResult Login(LoginModel model, string returnUrl)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public HttpStatusCodeResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    WebSecurity.CreateUserAndAccount(model.UserName, model.Password, 
                        new
                            {
                                GmailAccount = model.Email,
                                GmailPassword = model.GmailPassword
                            });
